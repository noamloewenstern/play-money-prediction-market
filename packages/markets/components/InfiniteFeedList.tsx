...
import { useFeedInfinite } from '@play-money/api-helpers/client/hooks'
...
export function InfiniteFeedList({ emptyState }: { emptyState?: React.ReactNode }) {
  const sentinelRef = useRef<HTMLDivElement>(null)
  const { data, size, setSize, isValidating } = useFeedInfinite({ limit: 25 })
